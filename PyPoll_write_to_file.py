...
# Initilize variables for winning candidate, winning count, and winning percentage
winning_count = 0
...
with open(file_to_save, "w") as txt_file:
     ...
     for candidate_name in sorted_votes:
          ...
          candidate_results = (f"{candidate_name[0]} received {vote_percentage:.2%} of the total votes ({votes:,})\n")
